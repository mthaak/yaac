...
def main():
    global rtri, rquad, gui_screen, zoomAngle
    ...
    gui_screen = lamina.LaminaScreenSurface(0.985)  # (-3.3, 2.5, 6.6, 5))
    ...
    gui.add_widget(lbl)
    # create middle label
    mid = Label('Label Embedded in Middle Of Scene')
    mid.position = 200, 260
    gui.add_widget(mid)
    ...
    #  and install in gui    
    btn3 = Button('Zoom')
    btn3.connect_signal(SIG_CLICKED, zoomTog)
    btn3.position = 300, 440
    gui.add_widget(btn3)
